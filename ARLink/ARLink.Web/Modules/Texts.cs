    ...
    public static partial class Texts
    {
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText EmailSubject = "Reset Your ARLink Password";
                ...
                {
                    public static LocalText FormTitle = "Welcome to AR Link";
                ...
                {
                    public static LocalText ActivateEmailSubject = "Activate Your ARLink Account";
                    ...
                    public static LocalText FormTitle = "Sign up for ARLink";
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle = "ARLink";
        }
