...
{
    [Route("Services/Default/EmployeeSalary/[action]")]
    [ConnectionKey(typeof(MyRow)), ServiceAuthorize(typeof(MyRow))]
    public class EmployeeSalaryController : ServiceEndpoint
    {
            ...
            [FromServices] IExcelExporter exporter)
        {
            ...
            var bytes = exporter.Export(data, typeof(Columns.EmployeeSalaryColumns), request.ExportColumns);
            return ExcelContentResult.Create(bytes, "EmployeeSalaryList_" +
