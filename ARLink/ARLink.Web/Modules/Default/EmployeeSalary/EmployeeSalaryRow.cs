...
{
    [ConnectionKey("Default"), Module("Default"), TableName("[dbo].[Employee_Salary]")]
    [DisplayName("Employee Salary"), InstanceName("Employee Salary")]
    [ReadPermission("Administration:General")]
    [ModifyPermission("Administration:General")]
    public sealed class EmployeeSalaryRow : Row<EmployeeSalaryRow.RowFields>, IIdRow, INameRow
    {
        ...
        public EmployeeSalaryRow()
            : base()
        {
        }

        public EmployeeSalaryRow(RowFields fields)
            : base(fields)
        {
        }
