...
namespace MVC
{
    public static class Views
    {
        ...
        public static class Default
        {
            ...
            {
                public const string BillIndex = "~/Modules/Default/Bill/BillIndex.cshtml";
            }
            ...
            {
                public const string EmployeeSalaryIndex = "~/Modules/Default/EmployeeSalary/EmployeeSalaryIndex.cshtml";
            }

            public static class Expenditure
            {
                public const string ExpenditureIndex = "~/Modules/Default/Expenditure/ExpenditureIndex.cshtml";
            }

            public static class Month
            {
                public const string MonthIndex = "~/Modules/Default/Month/MonthIndex.cshtml";
            }

            public static class Package
            {
                public const string PackageIndex = "~/Modules/Default/Package/PackageIndex.cshtml";
            }
        }
